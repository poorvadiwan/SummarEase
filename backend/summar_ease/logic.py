...
from .subtitles import concatenate_subtitles, generate_srt_file
...
def video_gen(pdf_file_path: str, id: str):
    ...
    for i in range(len(chunk_list)):
        ...
        subtitles, start_time, subtitle_index = generate_srt_file([final_video_file], summary_sentences, start_time, subtitle_index)
