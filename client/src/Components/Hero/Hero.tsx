...
const Hero = (props: Props) => {
  return (
    ...
    >
      ...
      {/* Assets Area */}
      <Box className="absolute right-[10vw] top-[10vh] w-[20vw] h-[60vh] !bg-transparent">
        <Image
      ...
      <Box className="absolute right-[25vw] top-[65vh] w-[80px] h-[80px] !bg-transparent">
        <Image
      ...
      <Box className="absolute right-[5vw] top-[45vh] w-[80px] h-[80px] !bg-transparent">
        <Image
      ...
      <Box className="absolute right-[10vw] top-[67vh] w-[80px] h-[80px] !bg-transparent">
        <Image
